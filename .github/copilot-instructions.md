...
- 주요 기술 스택: Vue 3 (Composition API), TypeScript, Tailwind CSS, Vite.
...
- **엔드포인트 참조**: 연결된 API 문서를 분석하여 엔드포인트와 데이터 구조를 파악하고 코드를 생성한다.
- **기능 연결**: 
...
# 작업 지시 시 주의사항
- 코드를 생성하기 전에 먼저 정의된 API URL을 참조하여 필요한 데이터 스키마를 확인해라.
